...
/**
 * struct binary_tree_s - Binary_tree_nod
 *
 * @n: Int stored in the nod
 * @parent: Poynda to the parent nod
 * @left: Poynda to nod left child 
 * @right: Poynda to nod right child
 */
